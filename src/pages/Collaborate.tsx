        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-[#e0e0e0] flex flex-col">
              ...
              <Link to="/pricing">
                <Button variant="default" className="w-full gap-2">Explore Budget <ArrowRight className="w-4 h-4" /></Button>
              </Link>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-[#e0e0e0] flex flex-col">
              ...
              <Link to="/pricing">
                <Button variant="default" className="w-full gap-2">Explore Storyboard <ArrowRight className="w-4 h-4" /></Button>
              </Link>
              <p className="text-xs text-[#4E2273]/60 mt-3 text-center">Upgrade anytime. Your project stays intact.</p>
            </div>
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-[#5C28A3] flex flex-col relative overflow-hidden">
              ...
              <Link to="/pricing">
                <Button variant="default" className="w-full gap-2">Explore Studio <ArrowRight className="w-4 h-4" /></Button>
              </Link>
              <p className="text-xs text-[#4E2273]/60 mt-3 text-center">Upgrade anytime. Your project stays intact.</p>
            </div>
          </div>
