...
const CreativeAgencies = () => {
  const { t } = useTranslation('solutions-agencies');
  const indieCheckoutUrl = useIndieCheckoutUrl();

  return (
    <PageLayout>
      <SEO
        title="Creative Agency Production Software | Manage Projects & Teams | Pzaz"
        ...
        url="https://pzaz.io/film-production-solution/creative-agency-production-software"
        keywords={[
        ...
        canonical="https://pzaz.io/film-production-solution/creative-agency-production-software"
      />
