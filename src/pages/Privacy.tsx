  ...
  return (
    <PageLayout>
      ...
      <div className="pt-32 pb-20 px-6 max-w-6xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold text-[#20124D] mb-2">{t("privacy.page_title")}</h1>
        <p className="text-sm text-[#4E2273]/60 mb-10">{t("privacy.date")}</p>
        ...
        <div className="grid md:grid-cols-[260px_1fr] gap-12 items-start">
          ...
          <aside className="sticky top-28 hidden md:block">
            <div className="bg-[#F8F2FF] rounded-2xl p-6 border border-[#D4BAF4]">
              <p className="text-xs font-bold uppercase tracking-widest text-[#5C28A3] mb-4">{t("privacy.toc_label")}</p>
