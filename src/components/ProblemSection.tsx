            ...
            <div className="bg-white/30 py-8 px-8 md:px-[60px] md:pb-[50px] border border-[#D4BAF4] rounded-[38px] relative z-10">
              <div className="space-y-4 pt-4">
                <div className="flex items-start gap-4 p-6 bg-[#FDF2F5] rounded-lg border border-[#EF6F9B]">
                  ...
                  <div>
                    <p className="text-[20px] font-lato font-bold leading-snug text-[#3E3A4B]">Context Loss</p>
                ...
                <div className="flex items-start gap-4 p-6 bg-[#FDF2F5] rounded-lg border border-[#EF6F9B]">
                  <img src={iconWarning} alt="" className="w-6 h-6 mt-1 flex-shrink-0" />
                  <div>
                    <p className="text-[20px] font-lato font-bold leading-snug text-[#3E3A4B]">Digital Fatigue</p>
                ...
                <div className="flex items-start gap-4 p-6 bg-[#FDF2F5] rounded-lg border border-[#EF6F9B]">
                  <img src={iconWarning} alt="" className="w-6 h-6 mt-1 flex-shrink-0" />
                  <div>
                    <p className="text-[20px] font-lato font-bold leading-snug text-[#3E3A4B]">Fragmented Data</p>
