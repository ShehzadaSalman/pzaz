...
const Footer = () => {
  ...
  const footerLinks: Record<string, { label: string; route?: string; social?: string }[]> = {
    ...
    [t("footer.company")]: [
      ...
      { label: t("footer.schools"), route: `${p}/film-production-solution/film-school-production-software` },
      { label: t("footer.screenwriters"), route: `${p}/film-production-solution/screenwriting-software` },
      { label: t("footer.tv_series"), route: `${p}/film-production-solution/tv-production-software` },
      { label: t("footer.investors"), route: `${p}/film-production-solution/film-budgeting-software` },
    ],
    [t("footer.legal")]: [
