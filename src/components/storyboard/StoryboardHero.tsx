              ...
              <div className="bg-muted/50 rounded-xl aspect-[16/9] flex items-center justify-center relative overflow-hidden">
                <div className="absolute inset-4 bg-background rounded-lg shadow-inner flex flex-col">
                  ...
                  <div className="flex items-center gap-2 border-b border-border/50 px-4 py-2">
                    ...
                    <span className="text-xs font-medium hidden lg:block">Storyboard</span>
                    <div className="ml-auto flex gap-2">
                      {["Shot 1", "Shot 2", "Shot 3", "Shot 4"].map((s, i) => (
                  ...
                  <div className="flex-1 p-4 grid grid-cols-2 sm:grid-cols-4 gap-3">
                    {[
                      ...
                      { label: "MCU", note: "Character A" },
                      { label: "OTS", note: "Reaction" },
                      { label: "Close-Up", note: "Detail" },
                    ].map((frame, i) => (
                      <div key={i} className="flex flex-col gap-1">
                        <div className={`flex-1 rounded-lg border-2 ${i === 0 ? "border-primary/40 bg-primary/5" : "border-border/40 bg-muted/40"} flex items-center justify-center min-h-[60px] relative`}>
                        ...
                        <p className="text-[9px] font-medium text-foreground hidden lg:block">{frame.label}</p>
                        <p className="text-[8px] text-muted-foreground hidden lg:block">{frame.note}</p>
                      </div>
                    ))}
                  </div>
                </div>
