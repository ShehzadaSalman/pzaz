          ...
          >
            ...
            <div className="relative p-8 md:p-16 md:py-24 pb-12 text-center">
              <SectionHeader
                ...
                title={
                  <>
                    Bring Creative Energy Into
                    <br />
                    a Structured System
                  </>
                }
                titleClassName="text-4xl sm:text-5xl lg:text-6xl font-display font-bold text-primary-foreground"
                description="Storyboarding should feel dynamic, collaborative and fast. It should help ideas grow, not restrict them."
                descriptionClassName="text-xl text-primary-foreground/80 max-w-xl mx-auto mb-10"
              />

              <p className="text-primary-foreground/70 text-lg mb-8 max-w-2xl mx-auto">
                With Pzaz, creative momentum and production structure work together. You explore freely. You refine deliberately. You align naturally.
              </p>
