                ...
                <div className="absolute inset-4 bg-background rounded-lg shadow-inner flex">
                  <div className="w-16 lg:w-56 border-r border-border/50 p-3 hidden sm:block">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <span className="text-xs font-medium hidden lg:block">Studio Dashboard</span>
                    </div>
                    <div className="space-y-2">
                      {["Slate Overview", "Project A", "Project B", "Project C", "Financials"].map((item, i) => (
                  ...
                  <div className="flex-1 p-4 lg:p-6">
                    ...
                    <div className="grid grid-cols-3 gap-3 mb-4">
                      {["3 Active", "On Track", "2 Reviews"].map((label, i) => (
                  ...
                  <div className="w-16 lg:w-48 border-l border-border/50 p-3 hidden md:block">
                    <div className="text-xs font-medium mb-3 hidden lg:block">Slate Status</div>
                    <div className="space-y-2">
                      {["Project A", "Project B", "Project C", "Resources"].map((item, i) => (
