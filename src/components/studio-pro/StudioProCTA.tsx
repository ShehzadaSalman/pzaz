          ...
          >
            ...
            <div className="relative p-8 md:p-16 md:py-24 pb-12 text-center">
              <SectionHeader
                ...
                description="Studios rarely fail because they grow. They struggle when growth begins to outpace coordination. Studio Pro turns fragmented expansion into structured maturity."
                descriptionClassName="text-xl text-primary-foreground/80 max-w-xl mx-auto mb-4"
              />

              <p className="text-primary-foreground/70 text-lg mb-10 max-w-2xl mx-auto">
                Studio Pro is institutional infrastructure. Operate your slate in sync.
              </p>
              ...
              <p className="mt-6 text-sm text-primary-foreground/60">
                Multiple projects aligned. Visibility at the executive level.
              </p>
            </div>
          </motion.div>
        </div>
